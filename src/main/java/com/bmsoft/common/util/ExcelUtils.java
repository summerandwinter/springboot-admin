package com.bmsoft.common.util;
...
import com.bmsoft.common.annotation.ExportConfig;
import com.bmsoft.common.handler.ExportHandler;
import com.bmsoft.common.util.poi.convert.ExportConvert;
import com.bmsoft.common.util.poi.pojo.ExportItem;
...
public class ExcelUtils {
	...
	private void required$BuilderParams() {
		if (mClass == null) {
			throw new IllegalArgumentException("请先使用com.bmsoft.util.ExcelUtils.$Builder(Class<?>)构造器初始化参数。");
		}
	}
	...
	private void required$ExportParams() {
		if (mClass == null || mResponse == null) {
			throw new IllegalArgumentException(
					"请先使用com.bmsoft.util.ExcelUtils.$Export(Class<?>, HttpServletResponse)构造器初始化参数。");
		}
