var $MB_Redis_Bash = function () {
    $(document).ready(function () {
        ...
        printf("Last login: " + date + " on bmsoft, type `help` for help\n");
        displayPrompt();
        ...
        function help(arg) {
            ...
            if (hasArgs(arg)) {
                ...
                printf(" Redis bash with SpringBoot by <a href='http://www.bmsoft.com.cn' class='kw_b'>bmsoft</a>, version v0.0.1 - Snapshot \n");
